...
//     setDropdownVisible(false); // Close dropdown before switching role
...
//                 </div>
//                 <div>
//                   <span className="text-3xl font-bold text-white">Sawari Sewa</span>
//                   <div className="text-s">Trusted Ticketing Platform</div>
//                 </div>
//             </div>
//             <div className="flex items-center space-x-5">
...
//                             onClick={() => {
//                               setDropdownVisible(false); // Close dropdown first
//                               navigate(PATHS.DRIVERREGISTRATION);
//                             }} 
...
const Navbar = () => {
  ...
  return (
    <nav className='w-full relative z-50' ref={navbarRef}>
      <div className="bg-[#17252A] text-white py-4 relative">
        <div className='px-4 sm:px-6 lg:px-8 flex flex-wrap justify-between items-center'>
            <div className='flex items-center space-x-2'>
                <div className="w-20 h-20 flex items-center justify-center mr-8">
                    <span className="c text-8xl">🚌</span>
              ...
              {user ? (
                <div className="relative z-50">
                  ...
                  {dropdownVisible && (
                    <div
                      ref={dropdownRef}
                      className="absolute right-0 top-full mt-2 w-64 bg-white text-gray-800 shadow-2xl rounded-lg border border-gray-200 overflow-hidden z-[9999]"
                      style={{
                        position: 'absolute',
                        zIndex: 9999,
                    ...
                    >
                      {isSuperAdmin || isAdmin ? (
                        <button 
                          ...
                          className="block px-4 py-3 hover:bg-gray-100 w-full text-left transition-colors duration-200 border-b border-gray-200 last:border-b-0"
                        >
                          Log Out
                        </button>
                      ) : isApprovedDriver ? (
                        <>
                          <button 
                            onClick={handleSwitchRole}
                            className="block px-4 py-3 hover:bg-gray-100 w-full text-left transition-colors duration-200 border-b border-gray-200"
                          >
                            {isDriver ? "Switch to Passenger Mode" : "Switch to Driver Mode"}
                          </button>
                          <button 
                            onClick={handleLogout} 
                            className="block px-4 py-3 hover:bg-gray-100 w-full text-left transition-colors duration-200"
                          >
                            Log Out
                          </button>
                        </>
                        ...
                        <> 
                        {pendingApplication ? (
                          <div className="block px-4 py-3 text-red-600 w-full text-left border-b border-gray-200 bg-red-50">
                            <div className="font-medium">Application Pending</div>
                            <div className="text-sm text-red-500">Please wait for approval</div>
                          </div>
                        ) : (
                          <button 
                            onClick={() => {
                          ...
                          <button 
                            onClick={handleLogout} 
                            className="block px-4 py-3 hover:bg-gray-100 w-full text-left transition-colors duration-200 text-red-600 hover:bg-red-50"
                          >
                            🚪 Log Out
                          </button>
                        </>
