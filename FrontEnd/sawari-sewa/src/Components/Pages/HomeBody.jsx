...
//       navigate(`${PATHS.AVAILABLEVEHICLE}?startingPoint=${encodeURIComponent(selectedStartingPoint)}&destination=${encodeURIComponent(selectedDestinationPoint)}&vehicleType=${encodeURIComponent(selectedVehicle)}&departureDate=${encodeURIComponent(selectedDateFrom)}`);
//     } catch (error) {
...
export default function HomeBody() {
  ...
  const vehicleTypes = ["Bike", "Van", "Bus", "Jeep","Deluxe Bus", "Sofa Seater Bus"];
  const navigate = useNavigate();
