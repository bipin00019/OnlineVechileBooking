//single approved driver
import React, { useState, useEffect } from "react";
import { useParams } from "react-router-dom";
import { API_BASE_URL } from "../../config";
import Navbar from "../Navbar/Navbar";
import { viewApprovedDriver} from "../../services/DriverService";
import { toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

const ViewApprovedDriver = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchApprovedDriver = async () => {
      try {
        const data = await viewApprovedDriver(id);
        setApplication(data);
      } catch {
...
export default ViewApprovedDriver;