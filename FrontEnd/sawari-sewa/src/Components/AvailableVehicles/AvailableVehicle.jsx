...
const AvailableVehicle = () => {
 ...
 const handleReviewClick = (driverId) => {
  if (!driverId) {
    console.error("Missing driverId for navigation");
    return;
  }
  navigate(PATHS.DRIVERREVIEWS.replace(":driverId", driverId.toString()));
};
                      ...
                      <div className="flex flex-col space-y-4 justify-between w-full">
                        ...
                        <div className="bg-gray-50 px-6 py-3 border-t border-gray-200">
                          <div className="flex flex-wrap gap-4">
                            ...
                            onClick={() => handleReviewClick(vehicle.driverId)} 
                              >
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                              </svg>
