...
// import { setFareAndSchedule, checkScheduleExists } from '../../../services/DriverDashboardService';
...
//   // State to track if a schedule already exists
//   const [scheduleExists, setScheduleExists] = useState(false);

//   // Function to check if schedule exists
//   const checkForExistingSchedule = async () => {
//     try {
//       const result = await checkScheduleExists();
//       setScheduleExists(result);
//       return result;
//     } catch (err) {
...
//   // Check for existing schedule when component mounts
//   useEffect(() => {
...
//     const hasSchedule = await checkForExistingSchedule();
    
//     if (hasSchedule) {
//       // Show toast message if schedule already exists
...
//       // Update the schedule exists state
...
// export default BusDriverDashboardFeatures;
// import React, { useState, useEffect } from 'react';
...
//   const scheduleExists = passengerStats?.hasSchedule === true;
