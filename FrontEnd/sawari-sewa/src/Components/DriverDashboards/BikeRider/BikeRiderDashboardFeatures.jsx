...
const BikeRiderDashboardFeatures = () => {
  ...
  // Hardcoded values for bike riders
  const totalSeats = 1;
  const bookedSeats = 0;
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={totalSeats}
                    disabled
                    className="w-full p-2 rounded border border-gray-300 bg-gray-100 text-gray-700 cursor-not-allowed"
                  />
                  <p className="text-xs text-gray-500 mt-1">For bikes, total seats is fixed to 1</p>
                </div>
                <div>
                  <label className="block font-semibold text-gray-700">Booked Seats</label>
                  <input
                    ...
                    className="w-full p-2 rounded border border-gray-300 bg-gray-100 text-gray-700 cursor-not-allowed"
                  />
                  <p className="text-xs text-gray-500 mt-1">Starts at 0 until passengers book</p>
                </div>
                <div>
                  <label className="block font-semibold text-gray-700">Departure Date</label>
                  <input
