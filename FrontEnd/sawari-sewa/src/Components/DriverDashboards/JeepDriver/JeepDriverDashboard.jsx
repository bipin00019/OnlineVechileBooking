  ...
  useEffect(() => {
    const getAverageRating = async () => {
      try {
        ...
        // Update rider stats with the actual rating from API
        setRiderStats(prev => ({
          ...prev,
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <header className="bg-blue-600 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">Jeep Driver Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white p-4 rounded-lg shadow relative">
            ...
            <div className="flex items-center mt-2">
              <span className="text-2xl font-bold">{riderStats.rating.toFixed(1)}</span>
              <span className="text-yellow-500 ml-2">★</span>
              <span className="text-gray-500 ml-2 text-sm">({reviewStats.totalReviews} reviews)</span>
            </div>
            <button
...
export default JeepDriverDashboard;